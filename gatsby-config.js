...
module.exports = {
  ...
  siteMetadata: {
    title: `Saurabh Nandedkar`,
    author: `Saurabh Nandedkar`,
    firstName: `Saurabh`,
    lastName: `Nandedkar`,
    description: `Saurabh Nandedkar's personal site`,
    occupation: `Software Engineer`,
    keywords: [`Saurabh`, `Saurabh`, `Saurabh Nandedkar`, `EXTREMOPHILARUM`, `Personal`, `Blog`, `Resume`, `Projects`, `Work`],
    siteUrl:
      process.env.URL || process.env.DEPLOY_URL || `http://localhost:8001`,
    unemployed: true,
    designations: [
      `Coding Monkey`,
      `Jedi Master`,
